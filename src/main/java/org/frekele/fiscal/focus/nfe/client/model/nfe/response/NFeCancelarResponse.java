...
import org.frekele.fiscal.focus.nfe.client.model.nfe.response.body.NFeCancelarBodyResponse;
 ...
 */
@ResponseObject
public interface NFeCancelarResponse extends FocusNFeEntity {
    ...
    @Body
    NFeCancelarBodyResponse getBody();
